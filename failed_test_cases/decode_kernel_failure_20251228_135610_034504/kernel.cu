...
extern "C" __global__ void __launch_bounds__(128, 1) kernel_kernel(const bfloat16_t* __restrict__ K, const bfloat16_t* __restrict__ K_Cache, bfloat16_t* __restrict__ O, const bfloat16_t* __restrict__ Q, const bfloat16_t* __restrict__ V, const bfloat16_t* __restrict__ V_Cache, const int* __restrict__ block_tables, const int* __restrict__ context_lens, const int* __restrict__ cu_seqlens_k, const int* __restrict__ cu_seqlens_q, int MAX_SEQ_NUM_BLOCKS) {
  ...
  for (int page_block_idx_local = 0; page_block_idx_local < MAX_SEQ_NUM_BLOCKS; ++page_block_idx_local) {
    ...
    if (0 <= page_block_idx_global) {
      ...
      for (int i_6 = 0; i_6 < 4; ++i_6) {
        ...
        *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_6 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)) = condval_1;
      }
      #pragma unroll
      ...
      for (int ki = 0; ki < 8; ++ki) {
        ...
        for (int i_8 = 0; i_8 < 2; ++i_8) {
          tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki >> 2) * 2048) + (i_8 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_8 * 8));
        }
        for (int j = 0; j < 2; ++j) {
      ...
      for (int i_19 = 0; i_19 < 4; ++i_19) {
        ...
        *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_19 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)) = condval_3;
      }
      __syncthreads();
  ...
  for (int i_21 = 0; i_21 < 8; ++i_21) {
    uint4 condval_4;
    if ((((((((((int)threadIdx.x) >> 4) + kv_start_idx) >> 3) + i_21) < 56) && (0 <= (((i_21 * 8) + (((int)threadIdx.x) >> 4)) + kv_start_idx))) && (0 <= (((i_21 * 8) + (((int)threadIdx.x) >> 4)) + kv_start_idx)))) {
